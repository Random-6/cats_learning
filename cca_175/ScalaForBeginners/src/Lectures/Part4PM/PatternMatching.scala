...
object PatternMatching extends App{
  ...
  val greeting = bob match {
    ...
    case Person(n, a) => s"Hi, my name is $n and I aNd $a years old"
  ...
  2. What if no case is matched? A MatchError!!
  3. What's the type of the pattern match expression? Unified type of all the ypes in all the cases
